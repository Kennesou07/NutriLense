package org.nutrivision.bscs.capstone.detection.tflite;
...
public class DetectorFactory {
    public static YoloV5Classifier getDetector(
        ...
        if (modelFilename.equals("model295.tflite")) {
            labelFilename = "file:///android_asset/label295.txt";
            isQuantized = false;
            inputSize = 416;
        ...
        else if (modelFilename.equals("model35.tflite")) {
            labelFilename = "file:///android_asset/label35.txt";
            isQuantized = false;
            inputSize = 416;
